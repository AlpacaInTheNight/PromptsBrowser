...
import { clone, log, stringToPromptsArray } from "client/utils/index";
...
export default class ActivePrompts {

    private static currentPromptsList: {[key: string]: PromptEntity[]} = {};
    ...
    public static addStrToActive(str: string, atStart = false, supportExtendedSyntax: boolean = false) {
    ...
    public static applyStyle = applyStyle;
